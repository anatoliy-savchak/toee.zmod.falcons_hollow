...
import const_proto_items, const_proto_rings, const_proto_cloth, const_proto_wondrous, py06600_daemon_keep, utils_races, utils_npc_build, const_proto_npc
...
class CtrlGuardElite(ctrl_behaviour.CtrlBehaviour):
	@classmethod
