...
import const_proto_wondrous, const_proto_npc, utils_toee, const_proto_rings, const_proto_wands, module_quests, utils_pc, module_globals, const_proto_scrolls
...
class CtrlWizardQuoris(ctrl_behaviour.CtrlBehaviour):
	...
	def dialog_barter(self, npc):
		utils_item.barter_list(npc, PROTOS_WIZARD)
		return